...
class Sim(object):
       ...
       def __init__(self,
        ...
        Parameters:
           ...
           individual_sample_prob (float): Probability of sampling an individual within a sampled node, determining the likelihood each individual is chosen.
        ...
        self.individual_sample_prob=individual_sample_prob
       ...
       def setup_digraph(self,
             ...
             for (startpoint,length,direction) in directional:
                 ...
                 if direction=='E':                                            #East direction                        
                    for i in range(x[0],x[0]+l) :                                                                                                                   
                        digraph[(i,x[1])][(i+1,x[1])]['weight']*=m_high 
                 elif direction=='W':                                          #West direction                                                    
                      for i in range(x[0]-l,x[0]) :                                                                                                                   
                          digraph[(i+1,x[1])][(i,x[1])]['weight']*=m_high      
          ...
          for x in digraph.nodes():
              ...
              Nx=np.random.binomial(self.n_samples_per_node, self.individual_sample_prob)      #The number of individuals sampled in each sampled deme
          ...
          pos_dict = nx.get_node_attributes(digraph, "pos")
          ...
          sample_sizes_dict = nx.get_node_attributes(digraph, "sample_size")
          pops = [[i] * int(sample_sizes_dict[i]) for i in digraph.nodes]
       ...
       def compute_level_set(self,
           ...
           Parameters:
              ...
              mode (str): Either 'radiation' for radial expansion or 'directional' for linear, eastward expansion.
       ...
       def set_up_re(self,
            ...
            Parameters:
               ...
               re_mode (str): Specifies the mode of expansion, either 'radiation' (outward from the center) or 'directional' (linear, e.g., west-to-east).
